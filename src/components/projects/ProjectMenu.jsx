...
const localKubernetesProject = {
  slug: "local-kubernetes-church-microservices",
  shortName: "Local Kubernetes Church App",
  category: "Completed DevOps Platform Case Study",
  path: "/projects/local-kubernetes-church-microservices",
};

function ProjectMenu({ activeSlug }) {
  const menuProjects = [localKubernetesProject, ...projects];
