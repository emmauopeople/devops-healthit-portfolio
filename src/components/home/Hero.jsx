function Hero() {
  return (
    <section className="w-full overflow-hidden border-b border-slate-200 bg-gradient-to-r from-sky-50 via-white to-emerald-50">
      <div className="grid min-h-[340px] w-full lg:min-h-[38vh] lg:grid-cols-[minmax(2rem,1fr)_270px_minmax(2rem,0.5fr)_minmax(0,900px)_minmax(2rem,1fr)]">
        ...
        <div className="relative flex min-w-0 flex-col justify-center px-6 py-10 sm:px-10 lg:px-0">
          <h1 className="max-w-full whitespace-nowrap text-[clamp(0.95rem,4vw,3rem)] font-black leading-none tracking-normal text-slate-950">
